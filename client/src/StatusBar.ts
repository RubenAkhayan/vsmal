...
class MaStatusBarManager implements vscode.Disposable {
  ...
  constructor() {
    ...
    this.statusBar.text = 'Loading MA';
    this.statusBar.show();
    ...
    this.interruptButtonStatusBar.tooltip = 'Interrupt MA computation';
    this.interruptButtonStatusBar.color = 'rgba(255,100,100,1)';
    this.interruptButtonStatusBar.command = 'extension.ma.interrupt';
  ...
  public showState(state: State) {
    ...
    switch(state.status) {
      case 'stopped': {
        // this.statusBar.text = 'matop is not running.';
        this.statusBar.text = '';
...
export class StatusBar implements vscode.Disposable {
  private static manager : MaStatusBarManager|null = null;
  ...
  constructor() {
    if(StatusBar.manager === null) {
      StatusBar.manager = new MaStatusBarManager();
    }
  ...
  public setMatopStatus(running: boolean) {
